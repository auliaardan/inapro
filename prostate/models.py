...
class patientdata(models.Model):
    ...
    chief_complaint = models.TextField(verbose_name="Chief Complaint", help_text="Keluhan Utama")
...
class TreatmentRecord(models.Model):
    ...
    stadium = models.CharField(max_length=50, verbose_name="Stadium", help_text="", blank=True, null=True)
    grade = models.CharField(max_length=50, verbose_name="Grade", help_text="", blank=True, null=True)
    tumor = models.CharField(max_length=50, verbose_name="Tumor (T)", help_text="", blank=True, null=True)
    nodes = models.CharField(max_length=50, verbose_name="Nodes (N)", help_text="", blank=True, null=True)
    metastasis = models.CharField(max_length=50, verbose_name="Metastasis (M)", help_text="", blank=True, null=True)
    bone_scan = models.CharField(max_length=100, verbose_name="Bone Scan", help_text="", blank=True)
    pet_scan = models.CharField(max_length=100, verbose_name="Pet Scan", help_text="", blank=True)
    psma_pet_ct = models.CharField(max_length=100, verbose_name="PSMA PET/CT", help_text="", blank=True)
    choline_pet_ct = models.CharField(max_length=100, verbose_name="Choline PET/CT", help_text="", blank=True)
    fluoride_pet = models.CharField(max_length=100, verbose_name="Fluoride PET", help_text="", blank=True)
